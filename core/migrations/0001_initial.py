    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, error_messages={'unique': 'Это имя пользователя уже занято.'}, help_text='максимум 30 символов, ну и всякие другие требования', max_length=30, null=True, unique=True, validators=[django.core.validators.RegexValidator('^[\\w\\d_\\.,\\-]+(?: [\\w\\d_\\.,\\-]+)*$', 'Enter a valid username. This value may contain only letters, numbers and _ character.', 'invalid')], verbose_name='имя пользователя')),
